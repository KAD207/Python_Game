...
- basic structure
- while running:
  1. Collect & handle input   (event loop)
  2. Update game state        (nothing here yet)
  3. Draw everything          (screen.fill for now)
  4. Push to screen           (display.update)
  5. Wait for next frame      (clock.tick)
